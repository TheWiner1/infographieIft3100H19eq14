...
void Renderer::updateCamera() {
	...
	{
		camera->lookAt(light.getGlobalPosition());
	}
...
//===============================================ilumunation ============================================
	...
	ofPushMatrix();
	/*Alex*/
	////models[2]->enableMaterials();
	//material_1.setAmbientColor(ofFloatColor(0.24725f, 0.1995f, 0.0745f, 1.0f));
	//material_1.setDiffuseColor(ofFloatColor(0.75164f, 0.60648f, 0.22648f, 1.0f));
	////material_1.setEmissiveColor(ofFloatColor(0, 0, 0.2f, 1));
	//material_1.setSpecularColor(ofFloatColor(0.628281f, 0.555802f, 0.366065f, 1.0f));
	//material_1.setShininess(0.4f);
	//material_1.begin();
